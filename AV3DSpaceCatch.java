...
public class AV3DSpaceCatch extends JComponent
    ...
    public void DesenharEspaco(AV3DSpaceCatch comp)
        ...
        for (int i = 0; i < EspacoLinhas.length; i++)
            ...
            if ((Math.acos(ProdutoEscalarZo / Math.sqrt(xo * xo + zo * zo)) <= AnguloDirecaoIr) && (Math.acos(ProdutoEscalarZd / Math.sqrt(xd * xd + Math.cos(Phi) * zd * Math.cos(Phi) * zd)) <= AnguloDirecaoIr))
                {
            ...
            else if ((Math.acos(ProdutoEscalarZo / Math.sqrt(xo * xo + Math.cos(Phi) * zo * Math.cos(Phi) * zo)) > AnguloDirecaoIr) || (Math.acos(ProdutoEscalarZd / Math.sqrt(xd * xd + Math.cos(Phi) * zd * Math.cos(Phi) * zd)) > AnguloDirecaoIr))
                {
                comp.addLineG((int) (Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2) - 20 - CorrecaoX, Math.min(TamanhoPlanoX, TamanhoPlanoY) - 50 - CorrecaoY, (int) (Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2) - CorrecaoX, Math.min(TamanhoPlanoX, TamanhoPlanoY) - 40 - CorrecaoY, CorGuias);
            ...
            if ((Math.acos(ProdutoEscalaro / Math.sqrt(xo * xo + yo * yo + Math.cos(Phi) * zo * Math.cos(Phi) * zo)) < AnguloVisao + MargemAnguloVisao) && (Math.acos(ProdutoEscalard / Math.sqrt(xd * xd + yd * yd + Math.cos(Phi) * zd * Math.cos(Phi) * zd)) < AnguloVisao + MargemAnguloVisao) && (Math.min(xi, Math.min(yi, Math.min(xf, yf))) > 0) && (Math.max(xi, Math.max(yi, Math.max(xf, yf))) < Math.min(TamanhoPlanoX, TamanhoPlanoY)))
